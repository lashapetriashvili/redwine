...
@section('title', 'ახალი ცხრილი')

@section('navbar-title', 'ახალი ცხრილი')
    ...
    <div class="card" data-border="purple">
        ...
        <div class="card-content table-responsive">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group label-floating">
                        <label class="control-label">ცხრილის სახელი</label>
            ...
            <div class="text-center">
                <button type="button" class="btn btn-primary" id="btnRow">სტრიქონის დამატება</button>
                <button type="button" class="btn btn-primary" id="btnTimestamps">Timestamps-ის დამატება</button>
                <button type="button" class="btn btn-primary" id="btnCreate">ცხრილის შექმნა</button>
            </div>
    ...
    <script>
        $(function () {
            ...
            $('#database').appendGrid({
                initRows: 1,
                columns: [
                    { name: 'Name', display: 'ველი', type: 'text', ctrlAttr: { 'placeholder': 'ველი' }, ctrlCss: { 'margin-top': -20 } },
                    { name: 'Type', display: 'ტიპი', ctrlCss: { 'margin-top': -20 }, type: 'select', 
                        ctrlOptions: [
                            { label: 'INT', value: 'int' },
                    ...
                    { name: 'Length', display: 'სიგრძე', type: 'number', ctrlAttr: { 'placeholder': 'სიგრძე' }, ctrlCss: { 'margin-top': -20 } },
                    { name: 'Default', display: 'ავტო მნიშვნელობა', type: 'number', ctrlAttr: { 'placeholder': 'ავტო მნიშვნელობა' }, ctrlCss: { 'margin-top': -20 } },
                    ...
                    { name: 'AutoIncrement', display: 'ავტო გაზრდა', type: 'checkbox', ctrlCss: { 'margin-top': -15, height: 20 } },
                    { name: 'Index', display: 'ატრიბუტები ', type: 'select', ctrlOptions: { 0: 'არჩევა', 1: 'INDEX', 2: 'UNIQUE', 3: 'PRIMARY' }, ctrlAttr: { 'placeholder': 'Index' }, ctrlCss: { 'margin-top': -20 } },
                ],
                rowDragging: true,
            ...
            $('#btnCreate').click(function () {
                ...
                if($('#tableName').val() == ""){
                    redwine.note('danger', 'notifications', 'ცხრილის სახელი აუცილებელია!');
                    return false;
                }
                ...
                function(data){
                    ...
                    if (data) {
                        swal({
                            type: 'success',
                            title: 'ცხრილი წარმატებით შეიქმნა',
                            text: 'გსურს ამ ცხრილის გვერდის შექმნა?',
