...
@section('title', Redwine::userLang('redwine.permission.add role'))

@section('navbar-title', Redwine::userLang('redwine.permission.add role', [], true))
...
@section('content')
        ...
        <div class="card-content table-responsive">
            ...
            <table class="table table-hover">
                <thead class="text-pink text-uppercase">
                    ...
                    <th>{{ Redwine::userLang('redwine.permission.permission') }}</th>
                </thead>
                <tbody>
    ...
    <form action="/redwine/permission/add" method="post" id="add-form" class="text-right">
        ...
        <button class="btn btn-primary">{{ Redwine::userLang('redwine.permission.add') }}</button>
    </form>
@endsection
