...
@section('navbar-title', strtoupper($directorie))
                    ...
                    @if(Redwine::bladePermissionFail('read_language'))
                        @foreach($languages as $key => $lang)
                            <tr>
                                ...
                                <td>
                                    @if(Redwine::bladePermissionFail('read_language'))
                                        <a href="/redwine/lang/language/file/read/{{ $directorie }}/{{ basename($lang) }}" rel="tooltip" class="btn btn-warning btn-simple btn-xs">
                    ...
                    addTable: function () {
                        swal({
                            ...
                            if (result.value) {
                                ...
                                this.$http.post('/redwine/lang/language/add/{{ $directorie }}/' + result.value, data).then(function (data) {
                                    if (data.body) {
                                        swal({
                                            type: 'success',
                    ...
                    editTable: function (name) {
                        swal({
                            ...
                            if (result.value) {
                                ...
                                this.$http.post('/redwine/lang/language/edit/{{ $directorie }}/' + name + '/' + result.value, data).then(function (data) {
                                    if (data.body) {
                                        swal({
                                            type: 'success',
                                            showConfirmButton: false,
                    ...
                    deleteTable: function (name) {
                        swal({
                            ...
                            if (result.value) {
                                ...
                                this.$http.post('/redwine/lang/language/delete/{{ $directorie }}/' + name, data).then(function (data) {
                                    if (data.body) {
                                        swal({
                                            type: 'success',
                                            showConfirmButton: false,
