...
@section('title', 'გვერდის რედაქტირება')

@section('navbar-title', 'გვერდის რედაქტირება')
...
@section('content')
                        ...
                        <tr class="column">
                            ...
                            <td>
                                <div class="form-group" style="margin-top: 0px;">
                                    <input type="text" class="form-control displayName" placeholder="სახელი" value="{{ $column->display_name }}">
                                </div>
                            </td>
                            <td>
                    ...
                    @foreach($columnArray as $column)
                        ...
                        <tr class="column">
                            ...
                            <td style="position: relative;">
                                ...
                                @foreach($controller->column_detail($table, $column) as $detail)
                                    <pre class="text-pink">{{ $detail->Type }}</pre>
                                    @if($detail->Null)
                                        <pre class="text-pink">Null: {{ $detail->Null }}</pre>
                                    @endif
    ...
    <div class="text-right">
        <button class="btn btn-primary get" @click="get()">გვერდის რედაქტირება</button>  
    </div>
@endsection
