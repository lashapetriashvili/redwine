...
@section('title', Redwine::userLang('redwine.pages.new page'))

@section('navbar-title', Redwine::userLang('redwine.pages.new page'))
...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group label-floating">
                        ...
                        <input type="text" class="form-control" id="displayName" value="{@php echo $custompage; @endphp}">
                    </div>
                </div>
            </div>
                        ...
                        <tr class="column">
                            ...
                            <td>
                                <div class="form-group" style="margin-top: -5px;">
                                    <input type="text" class="form-control displayName" placeholder="{{ Redwine::userLang('redwine.pages.name') }}" style="min-width:120px" value="{@php echo $column->Field; @endphp}">
                                </div>
                            </td>
                            <td>
    ...
    <div class="text-right">
        <button class="btn btn-primary get" @click="get()">{{ Redwine::userLang('redwine.pages.create page') }}</button>  
    </div>
