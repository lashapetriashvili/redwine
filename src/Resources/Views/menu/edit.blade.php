        ...
        <div class="card text-card-show" data-border="pink">
            ...
            <div class="card-content table-responsive text-card">
                <div class="form-group label-floating">
                    <input type="text" class="form-control" id="label" placeholder="{{ Redwine::userLang('redwine.menu page.title') }}">
                </div>
                <div class="form-group label-floating"> 
                    <input type="text" class="form-control" id="link" placeholder="{{ Redwine::userLang('redwine.menu page.link') }}">
                </div>
                <div class="form-group label-floating"> 
                    <input type="text" class="form-control" id="icon" placeholder="{{ Redwine::userLang('redwine.menu page.icon') }}">
                </div>
                ...
                <div class="text-center">
                    <button class="btn btn-pink" id="submit">{{ Redwine::userLang('redwine.menu page.add') }}</button>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            @if(Request::is('redwine/menu/add'))
                function add() {
                    swal({
                        title: '{{Redwine::userLang('redwine.menu page.create new') }}',
                        input: 'text',
                        confirmButtonText: '{{ Redwine::userLang('redwine.menu page.create') }}',
                        ...
                        if (result.value) {
                            ...
                            $.ajax({
                                ...
                                success: function(data){
                                    ...
                                    if (data) {
                                        redwine.note('danger', 'notifications', '{{ Redwine::userLang('redwine.menu page.exist menu') }}');
                                        add();
                                    } else {
            ...
            var updateOutput = function (e) {
                ...
                if (window.JSON) {
                    ...
                    output.val('{{ Redwine::userLang('redwine.menu page.json') }}');
                }
            };
            ...
            $("#submit").click(function(){
                ...
                if ($("#menuName").val() == '') {
                    ...
                    if ($("#label").val() == '') {
                        redwine.note('danger', 'notifications', '{{ Redwine::userLang('redwine.menu page.name required') }}');
                    } else {
                        var dataString = { 
                            _token : '{{ csrf_token() }}',
                            label : $("#label").val(),
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                loadNestable();
                                change();
                                if ($("#submit").text() == '{{ Redwine::userLang('redwine.menu page.edit') }}') {
                                    redwine.note('success', 'notifications', '{{ Redwine::userLang('redwine.menu page.success edit') }}');
                                    $("#submit").text('დამატება');
                                } else {
                                    redwine.note('success', 'notifications', '{{ Redwine::userLang('redwine.menu page.success add') }}');
                                }
                                $('#label').val('');
                                $('#link').val('');
                                $("#icon").val('');
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                redwine.note('success', 'notifications', '{{ Redwine::userLang('redwine.menu page.success delete') }}');
                            } ,error: function(xhr, status, error) {
                                alert(error);
                            },
                        });
            ...
            $(document).on("click",".edit-button",function() {
                ...
                $("#submit").text('{{ Redwine::userLang('redwine.menu page.edit') }}');
            });
        });
    </script>
@endpush
