    ...
    <body>
        <div class="wrapper">
            <div class="sidebar">
                ...
                <div class="sidebar-wrapper text-uppercase">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-primary">
                                        <li>
                                            <a href="/redwine/page/users">{{ Redwine::userLang('redwine.layout.user', [], true) }}</a>
                                        </li>
                                        <li>
                                            <a href="/redwine/logout">{{ Redwine::userLang('redwine.layout.log out', [], true) }}</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
